<template>
  <div class="banner-1">
    ...
    >
      ...
      >
        <li class="menu-button"><a href="#">inicio</a></li>
        <li class="menu-button"><a href="#work" v-smooth-scroll>Projetos</a></li>
        <li class="menu-button">
          <a href="#testimonial" v-smooth-scroll>Tirar</a>
        </li>
        <li class="menu-button"><a href="#about" v-smooth-scroll>Sobre Min</a></li>
      </ul>
    </nav>
    <!-- End Navbar -->
  ...
  <div class="banner-2 md:flex items-center md:justify-evenly" id="about">
    ...
    />
    <div class="space-y-5 py-8 px-8 md:py-16 md:px-20 md:w-1/2">
      <h4 class="project-title item">Sobre Min</h4>
  ...
  <div class="banner-1 flex h-full items-center">
    <div class="w-7/12 p-12">
      <h2 class="text-gray-700 md:text-4xl text-2xl font-sans mb-5 font-bold">
        Contatos
      </h2>
      <a class="underline text-2xl text-blue-600 font-work_sans"
        >📧 Aldrikfariaalvaro@gmail.com</a
      >
    </div>
